...
const Home: NextPage = () => {
  return (
    <Layout
      title="Scura Mode extension install"
      des="Scura Mode Select Your Platform to install extension turn your browser to dark mode"
    >
      <div className="flex h-screen">
        <div className="m-auto text-center">
          <h1 className="text-6xl text-blod">Select Your Platform</h1>
          <p className="text-mute w-4/6 m-auto">
            This is an ALPHA version! It may be slow. It may be buggy. Available
